...
public class ClientInfo {
    ...
    public static void loader_test(int ID) {
        ...
        for (Channel channel : channels) {
            ...
            load.api.sendPrivateMessage(ID,channel.getName() + "    "  + channel.getId());
        }
        ...
        for (Client c :load.api.getClients()) {
            ...
            load.api.sendPrivateMessage(ID, c.getNickname() + " in channel " + channel.getName() + "  Unic ID: " + c.getUniqueIdentifier());
        }
    }
